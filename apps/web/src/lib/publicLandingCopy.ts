...
export const LANDING_SUPPORTING =
  "Convert audio into .mp5, play it back with MP5-L v4 lossless audio, and explore a format designed for rich metadata, cover art, lyrics, content guidance, waveform data, and future interactive audio.";

export const FORMAT_MP5_EXPLAINER =
  ".mp5 = one smart song (single track). MP5-L v4 is the recommended lossless codec.";
...
export const LANDING_SCREENSHOTS = [
  ...
  },
  {
    ...
    label: "Converter",
    alt: "MP5 Converter importing audio and exporting MP5-L v4",
  },
  {
