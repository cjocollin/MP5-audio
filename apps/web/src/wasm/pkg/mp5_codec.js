 ...
 * @returns {Int16Array}
 */
export function decode_mp5c(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_mp5c(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayI16FromWasm0(ret[0], ret[1]).slice();
...
export function decode_mp5c_vnext(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_mp5c_vnext(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayI16FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Int16Array}
 */
export function decode_mp5h(data, enhanced) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_mp5h(ptr0, len0, enhanced);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayI16FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Int16Array}
 */
export function decode_mp5l(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_mp5l(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayI16FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
export function encode_mp5c(samples, channels, preset) {
    const ptr0 = passArray16ToWasm0(samples, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.encode_mp5c(ptr0, len0, channels, preset);
 ...
 * @returns {Uint8Array}
 */
export function encode_mp5c_vnext(samples, channels, preset) {
    const ptr0 = passArray16ToWasm0(samples, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function encode_mp5h(samples, channels, preset) {
    const ptr0 = passArray16ToWasm0(samples, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.encode_mp5h(ptr0, len0, channels, preset);
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v2;
}
 ...
 * @returns {Uint8Array}
 */
export function encode_mp5l(samples, channels) {
    const ptr0 = passArray16ToWasm0(samples, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {number}
 */
export function snr_db_wasm(original, decoded) {
    ...
    const ret = wasm.snr_db_wasm(ptr0, len0, ptr1, len1);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('mp5_codec_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
