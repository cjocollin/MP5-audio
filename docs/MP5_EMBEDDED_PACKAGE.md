...
Embedded `.mp5p` packages use magic `MP5P`, manifest format `mp5-album-embedded-v1`, a track directory, and fragmented embedded `.mp5` payloads. v0.25.0-beta does not change MP5P semantics.
