...
This document is descriptive of the current reference implementation. v0.27.0-beta does not change codec policy, playback transport, MP5/STDF/MP5P semantics, or converter encoding behavior.
