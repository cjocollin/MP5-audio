...
| 5 | MP5-C2 (vNext) | Lab/advanced **lossless / bit-exact** (quiet→MP5-L, loud→`min(TAG_SR+CORR, TAG_LOSSLESS)`). AUDI payload magic `0x43 0x34`. Not default; gated in Converter |
