...
**Version:** MP5 Audio **v0.15.1-alpha** · **Date:** May 2026 · **Status:** **Embedded album / batch album hotfix** (experimental Alpha — not Beta yet)
...
**v0.15.1-alpha — Batch album / embedded MP5P hotfix:** Play album queues full embedded albums lazily; first-track cover fallback; batch metadata editor performance; playback state sync for Play album — see [`MP5_ALBUM_PACKAGE.md`](MP5_ALBUM_PACKAGE.md).
